...
#define STRG_ADDR 40305 // enable (dis-)charge limits bitfield
#define CAPACITY (0)
//#define MAX_DIS_CHRG_RATE (40347 - STRG_ADDR)
//#define LIMIT_MODE (40348 - STRG_ADDR)
#define RESERVE_PERC (5)
#define SOC_PERC (6)
#define DIS_CHRG_PERC (10)
//#define CHRG_PERC (40356 - STRG_ADDR)
#define CHARGE_FROM_GRID (15)
#define CAPACITY_SF (16)
//#define MAX_CHRG_DIS_CHRG_SF (40362 - STRG_ADDR)
#define RESERVE_PERC_SF (19)
#define SOC_PERC_SF (20)
#define CHRG_DIS_CHRG_SF (23)
...
int calcDischargeHours(config_t *cfg, int count, int month, float kWh);

#define CONFIGREADER_CONFIGREADER_H

#endif //CONFIGREADER_CONFIGREADER_H
